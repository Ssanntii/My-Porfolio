...
const NavBar = () => {
    ...
    const NavBarLinks = [
        ...
        {id:2, name: 'About Me', link: '#about_me'},
    ...
    return(
        <header className="fixed top-0 left-0 w-full z-20 text-white" data-aos='fade-up' data-aos-delay='300'>
            <div className="container mx-auto flex items-center justify-between p-5">
                {/*LOGO*/}
                <a href="#home" className="text-4xl font-bold italic text-white">My Portfolio </a>
                ...
                {/*Mobile Navigation*/}
                <div
                className={`${isOpen ? 'block' : 'hidden'} md:hidden bg-[#801b9c] absolute top-0 left-0
                w-full h-screen flex flex-col items-center justify-center space-y-8 pt-16`}>
                    {/*Close Button*/}
